...
namespace ClearMapperLibrary
{
    ...
    {
        public static IServiceCollection UseCleverMapper(this IServiceCollection services, Action<ClearMapperOption> option, ServiceLifetime? serviceLifetime = ServiceLifetime.Scoped)
        {
